...
<body>
    ...
    <div class="modal" id="loginModal">
        <div class="modal-content">
            <div class="modal-header">
                <div class="logo img">
                    <img src="logo-Photoroom.png" alt="Logo"></div>
        ...
        <div class="product-modal-new-content">
            ...
            <div class="product-modal-new-body">
                ...
                <div class="product-modal-details-wrapper">
                    ...
                    <p>Uma pulseira elegante e discreta, perfeita para o dia a dia. Fabricada com borracha de alta qualidade, oferece conforto e durabilidade.</p>
                    ...
                    <div class="action-buttons">
                        ...
                        <button class="btn-add-cart add-to-cart-btn" data-id="info-01" data-name="Pulseira Informática" data-price="9.99" data-image="assets/images/PulseiraInfo.png">ADICIONAR AO CARRINHO</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="product-modal-new-content">
            ...
            <div class="product-modal-new-body">
                ...
                <div class="product-modal-details-wrapper">
                    ...
                    <p>Mostre sua paixão por Eletrônica com esta pulseira vibrante. Feita para durar, ela simboliza a energia e a precisão dos circuitos.</p>
                    <div class="price-container">
                        <span class="product-price-new">R$ 9,99</span>
                        <span class="product-price-old">R$ 12,99</span>
                    </div>
    ...
    <div class="modal" id="mecModal">
        <div class="product-modal-new-content">
            <button class="close-btn-new" data-close-modal>&times;</button>
            <div class="product-modal-new-body"><div class="product-modal-image-wrapper">
                <img src="assets/images/PulseiraMec.png" alt="Pulseira Mecânica">
            </div>
            <div class="product-modal-details-wrapper">
                <img src="assets/images/logo-Photoroom.png" alt="PulsoTech" class="modal-logo">
                <h2>Pulseira de MEC - Força e Engenhosidade</h2>
                <p>Esta pulseira robusta representa a força, a durabilidade e a engenhosidade das grandes máquinas e projetos mecânicos.</p>
                <div class="price-container">
                    <span class="product-price-new">R$ 9,99</span>
                    <span class="product-price-old">R$ 12,99</span>
                </div>
